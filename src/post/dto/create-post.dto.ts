...
export class CreatePostDto {
    ...
    @Length(10, 200, {message: "Excerto precisa ter entre 10 e 150 caracteres"})
    excerpt: string;
    ...
    @IsUrl({ require_tld: false }, {message: "URL da imagem precisa ser uma URL válida!"}) // TLD (Top-Level Domain) é a parte final do domínio. se deixar como true ele exige que a url tenha um TLD válido e proíbe localhost e IP
